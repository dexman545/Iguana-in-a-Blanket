...
public class IguanaEntityAttributes {
    public static final EntityAttribute MAX_WEIGHT = (new ClampedEntityAttribute(null, "generic.max-carry-weight", IguanaBlanket.cfg.defaultEntityMaxWeight(), 1.0D, 1024.0D)).setName("MaxWeight").setTracked(true);
    ...
    public static final EntityAttribute SUSCEPTIBILITY = (new ClampedEntityAttribute(null, "generic.susceptibility", IguanaBlanket.cfg.defaultEntitySusceptibility(), 1.0D, 1024.0D)).setName("Susceptibility").setTracked(true);
