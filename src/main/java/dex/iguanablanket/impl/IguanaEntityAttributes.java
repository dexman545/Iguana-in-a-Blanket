...
public class IguanaEntityAttributes {
    public static final EntityAttribute MAX_WEIGHT = (new ClampedEntityAttribute(null, "generic.max-carry-weight", IguanaBlanket.cfg.defaultEntityMaxWeight() >= 1 ? IguanaBlanket.cfg.defaultEntityMaxWeight() : 1, 1.0D, 1024.0D)).setName("MaxWeight").setTracked(true);
